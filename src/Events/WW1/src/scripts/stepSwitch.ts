...
/*Events*/
let assassinationEvent: HTMLAreaElement = document.getElementById('assassinationEvent') as HTMLAreaElement;
let battleOfLiegeEvent: HTMLAreaElement = document.getElementById('battleLiege') as HTMLAreaElement;
let battleOfCharleroiMonse: HTMLAreaElement = document.getElementById('battleCharleroiMonse') as HTMLAreaElement;
let battleOfGumbinnen: HTMLAreaElement = document.getElementById('battleGumbinnen') as HTMLAreaElement;
let battleOfTannenberg: HTMLAreaElement = document.getElementById('battleTannenberg') as HTMLAreaElement;
let battleOfGalicia: HTMLAreaElement = document.getElementById('battleGalicia') as HTMLAreaElement;
let temp;
